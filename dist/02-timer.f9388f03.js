...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDates[0] < currentTime) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else {
            startBtn.disabled = false;
...
(0, _flatpickrDefault.default)(dataInput, options);
